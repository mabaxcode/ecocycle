								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Inventory Setting</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
										...
										<div class="d-flex align-items-center gap-2 gap-lg-3">
											<a href="#" class="btn btn-flex btn-info btn-sm fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_new_address">+ Add New Category</a>
										...
										<div class="card-body py-4">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="dt_staff_list">
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<? foreach ($inventory_category as $key) { ?>
													<tr>	
														<td><?=$key['descs']?></td>
														<td>I-<?=$key['id']?></td>
				...
				<div class="modal-content">
					...
					<form class="form" action="#" id="kt_modal_new_address_form">
						...
						<div class="modal-header" id="kt_modal_new_address_header">
							<!--begin::Modal title-->
							<h2>Add New Inventory Category</h2>
							<!--end::Modal title-->
							<!--begin::Close-->
						...
						<div class="modal-footer flex-center">
							<!--begin::Button-->
							<button type="reset" id="kt_modal_new_address" class="btn btn-light me-3" data-bs-dismiss="modal">Discard</button>
							<!--end::Button-->
							<!--begin::Button-->
