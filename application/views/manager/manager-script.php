            ...
            (i = document.querySelector("#kt_modal_new_address")) && (o = new bootstrap.Modal(i), a = document.querySelector("#kt_modal_new_address_form"), t = document.getElementById("kt_modal_new_address_submit"), e = document.getElementById("kt_modal_new_address_cancel"), new Tagify(a.querySelector('[name="tags"]'), {
                ...
                e.preventDefault(), n && n.validate().then((function(e) {
                    console.log("validated!"), "Valid" == e ? (t.setAttribute("data-kt-indicator", "on"), t.disabled = !0, setTimeout((function() {
                        ...
                        $.ajax({
                            url: base_url + 'manager/do_centre_registration',
                            type: "POST",
                            data: workshopForm,
                            dataType: "json",
                            async: true,
...
$(document).on('click', '.detail-register', function(e){
    var id = $(this).data('init');
    e.preventDefault();
    $.ajax({
        url: base_url + 'manager/view_centre_registation',
        type: "POST",
        data: {id:id},
        async: true,
        success: function( response ){
...
$(document).on('click', '.complete-register', function(e){
    ...
    e.preventDefault();
    $.ajax({
        url: base_url + 'manager/complete_staff_register',
        type: "POST",
        data: {id:id},
        async: true,
        success: function( response ){
...
var table_staff_complete = $('#result-staff-centres');
    ...
    var KTDatatablesDataSourceAjaxServer333 = function () {
        ...
        var initTableComplete = function () {
            ...
            table_staff_complete.DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: base_url + "manager/record_staff", type: "POST",
                    data: function (d) {
                        return $.extend({}, d, {
    ...
    var KTModalNewTargetAddStaff = function() {
    var t, e, n, a, o, i;
    return {
        init: function() {
            (i = document.querySelector("#kt_modal_new_address_staff")) && (o = new bootstrap.Modal(i), a = document.querySelector("#kt_modal_new_address_form_staff"), t = document.getElementById("kt_modal_new_address_submit_staff"), e = document.getElementById("kt_modal_new_address_cancel_staff"), new Tagify(a.querySelector('[name="tags"]'), {
                whitelist: ["Important", "Urgent", "High", "Medium", "Low"],
                maxTags: 5,
                dropdown: {
                    maxItems: 10,
                ...
                var workshopFormStaff = $('#kt_modal_new_address_form_staff').serialize();
                e.preventDefault(), n && n.validate().then((function(e) {
                    console.log("validated!"), "Valid" == e ? (t.setAttribute("data-kt-indicator", "on"), t.disabled = !0, setTimeout((function() {
                        t.removeAttribute("data-kt-indicator"), t.disabled = !1,
                        // doRegister(workshopFormStaff);
                        $.ajax({
                            url: base_url + 'manager/do_add_staff',
                            type: "POST",
                            data: workshopFormStaff,
                            dataType: "json",
                            async: true,
                            success: function( response ) {
                                // console.log(response);
...
KTUtil.onDOMContentLoaded((function() {
    KTModalNewTargetAddStaff.init()
}));


var KTModalNewTargetAddStaffAcc = function() {
    var t, e, n, a, o, i;
    return {
        init: function() {
            (i = document.querySelector("#kt_modal_new_address_staff_acc")) && (o = new bootstrap.Modal(i), a = document.querySelector("#kt_modal_new_address_form_staff_acc"), t = document.getElementById("kt_modal_new_address_submit_staff_acc"), e = document.getElementById("kt_modal_new_address_cancel_staff_acc"), new Tagify(a.querySelector('[name="tags"]'), {
                whitelist: ["Important", "Urgent", "High", "Medium", "Low"],
                maxTags: 5,
                dropdown: {
                    maxItems: 10,
                ...
                var workshopFormStaff = $('#kt_modal_new_address_form_staff_acc').serialize();
                e.preventDefault(), n && n.validate().then((function(e) {
                    console.log("validated!"), "Valid" == e ? (t.setAttribute("data-kt-indicator", "on"), t.disabled = !0, setTimeout((function() {
                        t.removeAttribute("data-kt-indicator"), t.disabled = !1,
                        // doRegister(workshopFormStaff);
                        $.ajax({
                            url: base_url + 'manager/do_create_staff_acc',
                            type: "POST",
                            data: workshopFormStaff,
                            dataType: "json",
                            async: true,
...
KTUtil.onDOMContentLoaded((function() {
    KTModalNewTargetAddStaffAcc.init()
}));
...
$(document).on('click', '.btn-register-staff', function (e) {
    ...
    validateStaffComplete.validate().then(function(status) {
        ...
        if (status == 'Valid') {
            ...
            $.ajax({
                url: base_url + 'manager/do_register_staff',
                type: "POST",
                data: newStaffFormData,
                dataType: "json",
                async: true,
