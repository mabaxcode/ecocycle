															...
															*/?>
															...
															<div class="mt-5">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="pages/user-profile/overview.html" class="text-gray-700 text-hover-primary">
																		<?=ucfirst($users['name'])?>
																	</a>
																	<!--end::Author-->
																	<!--begin::Date-->
																...
																<div class="fs-6 fw-bold mt-5 d-flex flex-stack">
																	<!--begin::Label-->
																	<? if($blog['status'] == '0'){ ?>
																	<span class="badge border border-dashed fw-bold text-gray-900 p-2">
																	...
																	<!--end::Label-->
																	<!--begin::Action-->
																	<a href="<?=base_url('manager/process_blog/'.$blog['id'])?>" class="btn btn-sm btn-primary">Action</a>
																	<!--end::Action-->
																</div>
																<!--end::Text-->
															</div>
