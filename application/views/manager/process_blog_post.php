								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="d-flex align-items-center gap-2 gap-lg-3">
											<!-- <a href="#" class="btn btn-flex btn-outline btn-color-gray-700 btn-active-color-primary bg-body h-40px fs-7 fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">Reject</a> -->
											<a href="javascript:void(0);" class="btn btn-flex btn-danger h-40px fs-7 fw-bold reject-post" data-init="<?=$blog['id']?>">Reject</a>
											<a href="javascript:void(0);" class="btn btn-flex btn-primary h-40px fs-7 fw-bold approve-post" data-init="<?=$blog['id']?>">Approve & Publish</a>
										</div>
										<!--end::Actions-->
									</div>
									<!--end::Toolbar wrapper-->
												...
												<div class="flex-lg-row-fluid me-xl-15">
													...
													<div class="mb-17">
														...
														<div class="mb-8">
															...
															<span class="fw-bold text-muted fs-5 ps-1"><?=ucfirst($users['name'])?></span></a>
															<!--end::Title-->
															<!--begin::Container-->
															<?/*
														...
														<div class="d-flex align-items-center gap-2 gap-lg-3">
															<a href="<?=base_url('manager/blog_post')?>" class="btn btn-flex btn-primary h-40px fs-7 fw-bold"><i class="ki-duotone ki-black-left fs-1"></i>Back</a>
														</div>
