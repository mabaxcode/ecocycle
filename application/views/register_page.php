  ...
  <main class="main">
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Register</h2>
        <div><span>Don't have an account yet?</span> <span class="description-title">Register with us today!</span></div>
            ...
            <form action="forms/contact.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="200">
              <div class="row gy-4">
                ...
                <div class="col-md-12">
                  ...
                  <input type="password" class="form-control" name="subject" placeholder="" required="">
                </div>
