								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Certificate Management</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
										...
										<div class="d-flex align-items-center gap-2 gap-lg-3">
											<a href="<?=base_url('staff/gen_cert')?>" class="btn btn-flex btn-outline btn-color-gray-700 btn-active-color-primary bg-body h-40px fs-7 fw-bold"><i class="ki-duotone ki-black-left fs-1"></i>Back To Home</a>
									...
									<div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-10" style="background-size: auto calc(100% + 10rem); background-position-x: 100%; background-image: url('assets/media/illustrations/sketchy-1/4.png')">
										...
										<div class="card-header pt-10">
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column">
													<h2 class="mb-1"><?=strtoupper($event['name'])?></h2>
													<div class="text-muted fw-bold">
													<a href="#"><?=$event['location']?></a>
													<span class="mx-3">|</span>
													<a href="#"><?=dmy($event['event_dt'])?></a>
										...
										*/?>
										<div class="card-body pb-0">
											<!--begin::Navs-->
											<div class="d-flex overflow-auto h-55px">
												<span class="mx-3"><?=$event['justification']?></span>
											</div>
											<!--begin::Navs-->
											<!--begin::Alert-->
											<div class="alert alert-primary d-flex align-items-center p-5">
											    ...
											    <div class="d-flex flex-column">
											        ...
											        <!--begin::Content-->
											        <span>Certificate will be generate to those who is check-in to the event only.</span>
											        <!--end::Content-->
											    </div>
											    <!--end::Wrapper-->
											</div>
										...
										<div class="card-header pt-8">
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card toolbar-->
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
													...
													<!--end::Export-->
													<!--begin::Add customer-->
													<button type="button" class="btn btn-flex btn-primary generate-cert-btn" data-init="<?=$event['id']?>">
													<i class="ki-outline ki-folder-up fs-2"></i>Generate Certificate</button>
													<!--end::Add customer-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
										...
										<div class="card-body">
											...
											<div class="d-flex flex-stack">
												...
												<div class="badge badge-lg badge-primary">
													...
													<span id="kt_file_manager_items_counter"><?=$total?> Volunteer</span>
												</div>
												<!--end::Folder Stats-->
											</div>
											<!--end::Table header-->
											...
											<table id="kt_file_manager_list" data-kt-filemanager-table="folders" class="table align-middle table-row-dashed fs-6 gy-5">
												...
												<tbody class="fw-semibold text-gray-600">
													...
													<?
													$user = get_any_table_row(array('id' => $app['user_id']), 'users');
													?>
													<tr>
														<td><?=$no++;?></td>
														<td data-order="account">
															<div class="d-flex align-items-center">
																...
																<a href="javascript:void(0)" class="text-gray-800 text-hover-primary"><?=$user['name']?></a>
															</div>
														</td>
														<td><?=$user['email']?></td>
														<td>
														...
														<td class="text-end" data-kt-filemanager-table="action_dropdown">
															<div class="d-flex justify-content-end">
																...
																<!-- <a href="" class="btn btn-sm btn-light btn-active-light-primary">View Certificate</a> -->
																...
																<div class="ms-2" data-kt-filemanger-table="copy_link">
																	...
																	-
																	<? } else { ?>
																	<a href="<?=base_url('pdfController/generate_certificate/'.$app['id'])?>" target="_BLANK" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-init="<?=$app['id']?>">
																		 View Certificate
																	</a>
																	<? } ?>
