								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Events Check-In</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-muted">Events Check-In</li>
												<!--end::Item-->
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<tr>
														...
														<td class="text-end">
															...
															$event_date = $key['event_dt'];

															$curr_date_only = dmy(current_date());
															$event_date_only = dmy($key['event_dt']);

															if (strtotime($event_date) < strtotime($current_date) && ($curr_date_only <> $event_date_only)) {
															    echo '<span class="badge badge-success">Event Completed</span>';
															} elseif (strtotime($event_date) < strtotime($current_date) && ($curr_date_only == $event_date_only)) {
																?>
															<a href="javascript:void(0);" class="btn btn-light btn-info btn-flex btn-center btn-sm modal-check-in-v" data-init="<?=$key['id']?>">Volunteer Check-In</a>
																<?
															} else {
															    // echo "<font color='red'>Not Start Yet</font>";
															    echo '<span class="badge badge-danger">Not Start Yet</span>';
															}
